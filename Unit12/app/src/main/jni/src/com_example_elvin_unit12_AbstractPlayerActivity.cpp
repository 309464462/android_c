...
jlong Java_com_example_elvin_unit12_AbstractPlayerActivity_open(
		JNIEnv* env,
		jclass clazz,
		jstring fileName)
{
...
jint Java_com_example_elvin_unit12_AbstractPlayerActivity_getWidth(
		JNIEnv* env,
		jclass clazz,
		jlong avi)
{
...
jint Java_com_example_elvin_unit12_AbstractPlayerActivity_getHeight(
		JNIEnv* env,
		jclass clazz,
		jlong avi)
{
...
jdouble Java_com_example_elvin_unit12_AbstractPlayerActivity_getFrameRate(
		JNIEnv* env,
		jclass clazz,
		jlong avi)
{
...
void Java_com_example_elvin_unit12_AbstractPlayerActivity_close(
		JNIEnv* env,
		jclass clazz,
		jlong avi)
{
