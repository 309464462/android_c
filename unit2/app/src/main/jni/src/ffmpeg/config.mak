...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/e/androidtest/androidc++/android_c/unit2/app/src/main/jni/src/ffmpeg/android/x264_lib/arm --enable-asm --enable-neon --enable-static --enable-small --enable-libx264 --enable-gpl --enable-encoder=libx264 --disable-shared --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-symver --cross-prefix='D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-' --target-os=linux --arch=arm --cpu=armv7-a --enable-cross-compile --sysroot='D:/Androidsdk/ndk-bundle/platforms/android-19/arch-arm/' --extra-cflags='-I/e/androidtest/androidc++/android_c/unit2/app/src/main/jni/src/ffmpeg/android-lib/include -fPIC -DANDROID -mfpu=neon -mfloat-abi=softfp -ID:/Androidsdk/ndk-bundle/platforms/android-19/arch-arm/usr/include' --extra-ldflags='-L/e/androidtest/androidc++/android_c/unit2/app/src/main/jni/src/ffmpeg/android-lib/lib -lx264 '
...
ARCH=arm
INTRINSICS=neon
CC=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
CXX=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-g++
AS=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
LD=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=D:/Androidsdk/ndk-bundle/platforms/android-19/arch-arm/ -isysroot D:/Androidsdk/ndk-bundle/platforms/android-19/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -I/e/androidtest/androidc++/android_c/unit2/app/src/main/jni/src/ffmpeg/android-lib/include -fPIC -DANDROID -mfpu=neon -mfloat-abi=softfp -ID:/Androidsdk/ndk-bundle/platforms/android-19/arch-arm/usr/include -march=armv7-a -std=c11 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/e/androidtest/androidc++/android_c/unit2/app/src/main/jni/src/ffmpeg/android-lib/include -fPIC -DANDROID -mfpu=neon -mfloat-abi=softfp -ID:/Androidsdk/ndk-bundle/platforms/android-19/arch-arm/usr/include -march=armv7-a -fPIC -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=D:/Androidsdk/ndk-bundle/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -L/e/androidtest/androidc++/android_c/unit2/app/src/main/jni/src/ffmpeg/android-lib/lib -lx264  --sysroot=D:/Androidsdk/ndk-bundle/platforms/android-19/arch-arm/ -isysroot D:/Androidsdk/ndk-bundle/platforms/android-19/arch-arm/ -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
